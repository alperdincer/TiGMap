...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.mekansal.TiGMap.js')
	...
	f = os.path.join(cwd,'Classes','ComMekansalTiGMapModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.mekansal.TiGMap.js']
